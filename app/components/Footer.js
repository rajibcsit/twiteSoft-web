              ...
              <div className="row justify-center">
                  ...
                  <div className="footer_link_wrapper flex flex-wrap mx-3">
                    <div className="footer_link w-1/2 md:pl-13 mt-10">
                      ...
                      <ul className="link pt-4">
                        <li>
                          <a href="#" className="text-slate-500 mt-4 hover:text-[rgb(1,104,198)]">
                            Company
                          </a>
                        </li>
                        <li>
                ...
                <div className="w-full md:w-2/3 lg:w-4/12">
                  <div className="footer_subscribe mt-10 mx-3">
                    <h2 className="footer_title text-xl font-semibold text-slate-500">Find Us</h2>
                    <div className="subscribe_form mt-9 relative">
                      <p className="text-slate-500 mt-4 ">Email: twitesoft@gmail.com</p>
                      <p className="text-slate-500 mt-4 ">Phone: +8801914-682468</p>
